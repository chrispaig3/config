...
cargo install cargo-edit cargo-audit cargo-geiger cargo-outdated cargo-mutants cargo-deny cargo-generate cargo-info cargo-show-asm cargo-expand cargo-about cargo-license cargo-release cargo-watch cargo-tarpaulin cargo-shuttle sccache bpf-linker bindgen-cli hyperfine trunk ripgrep nu slint-lsp  
